...
export default function ProductDesc() {
    ...
    return (
        <div className="bg-white">
            ...
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24  lg:grid lg:max-w-4xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                ...
                <div className="lg:max-w-lg lg:self-end">
                    <nav aria-label="Breadcrumb">
                        <ol role="list" className="flex items-center space-x-2">
                            ...
                            <a
                                ...
                                <BackwardIcon className="h-5 w-5  flex-shrink-0 text-black" aria-hidden="true" />
                                <h1 className='text-black'> Marketplace </h1>
                            </a>
                    ...
                    <section aria-labelledby="information-heading" className="mt-4">
                        ...
                        <div className="flex items-center">
                            <p className="text-lg text-gray-900 sm:text-xl">19.99</p>
