...
export default function ShoppingCart() {
    return (
        <div className="bg-white">
            ...
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-20 lg:px-0">
                <a
                ...
                <form className="mt-12">
                    ...
                    <section aria-labelledby="summary-heading" className="mt-10">
                        ...
                        <div className="mt-6 text-center text-sm">
                            <p>
                                or
                                <a href="/pages/view/MarketPlace" className="font-medium text-indigo-600 hover:text-indigo-500">
                                    Continue Shopping
